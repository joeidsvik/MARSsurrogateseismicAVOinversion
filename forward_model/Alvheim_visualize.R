...
plot.traveltimes <- function(inline.idx, xline.idx){
  ...
  image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
             tt.area*convrt, 
             xlab="inline", ylab="xline",legend.args=list( text="Depth[m]"), 
...
trace.Gas <- function(d, filename=""){
  if (filename != ""){
    ...
    plot(d$gas$X100, type="l", main="", 
         xlab="iteration", ylab=TeX(r'($X_{100}$)'), cex.lab=1.4, cex.axis=1.3)
    dev.off()
  }
  else{
    #par(mar=c(4,5,2,1.5), oma =c(0,0,0,1))
    plot(d$gas$X400, type="l", main="", 
         xlab="iteration", ylab=TeX(r'($X_{400}$)'), cex.lab=1.7, cex.axis=1.6)
  }
}

#filename <- "/Users/karenauestad/Desktop/var2023/prosjektoppgave/Alvheim/plots/traceOil200.pdf"
trace.Oil <- function(d, filename=""){
  if (filename != ""){
    pdf(filename, width = 6, height = 6)
    par(mar=c(4,5,2,1.5), oma =c(0,0,0,1))
    plot(d$oil$X200, type="l", main="", 
         xlab="iteration", ylab=TeX(r'($X_{200}$)'), cex.lab=1.4, cex.axis=1.3)
    dev.off()
  }
  else{
    #par(mar=c(4,5,2,1.5), oma =c(0,0,0,1))
    plot(d$oil$X400, type="l", main="", 
         xlab="iteration", ylab=TeX(r'($X_{400}$)'), cex.lab=1.7, cex.axis=1.6)
  }
}
...
plot.Sg <- function(d, burn.in=1, filename =""){
  ...
  if (filename!=""){
    ...
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               map.mean.S.g, xlab="inline", ylab="xline", 
...
plot.So <- function(d, burn.in=1, filename =""){
  ...
  if (filename!=""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               map.mean.S.o, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1,
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6)) 
...
plot.Sb <- function(d, burn.in=1, filename =""){
  ...
  if (filename!=""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               map.mean.S.b, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
...
plot.Vcl <- function(d, burn.in=1, filename =""){
  ...
  if (filename!=""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               map.mean.V.cl, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
...
plot.mu.prior.gas <- function(inline.idx, xline.idx, filename = "", transformation = 0){
  ...
  if ( filename != ""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               prior.gas, xlab="inline", ylab="xline", 
               main="",  col = viridis(128), axes=F, 
               zlim = c(0,1),
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1,
...
plot.mu.prior.oil <- function(inline.idx, xline.idx, filename = "", transformation = 0){
  ...
  if (filename != ""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               prior.oil, xlab="inline", ylab="xline", 
               main="",  col = viridis(128), axes=F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
...
plot.mu.prior.brine <- function(inline.idx, xline.idx, filename = ""){
  ...
  if (filename != ""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               prior.brine, xlab="inline", ylab="xline", 
               main="",  col = viridis(128), axes=F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1,
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
...
plot.mu.prior.clay <- function(inline.idx, xline.idx, filename = "", transformation = 0){
  ...
  if (filename != ""){
    ...
    breaks <- seq(0, 1,  length.out=6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               prior.clay, xlab="inline", ylab="xline", 
               main="",  col = viridis(128), axes=F,
               zlim = c(0,1),
               cex.lab=1.4, cex.axis=1.3, legend.width = 1.5, legend.shrink=1,
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.3))
...
percentile <- function(d, inline.idx, xline.idx, bi=500, p=80, filename=""){
  ...
  if (filename!=""){
    ...
    pdf(paste(filename, "Gas.pdf"), width = 6, height = 6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx],
               S.g.matrix, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
    ...
    pdf(paste(filename, "Oil.pdf"), width = 6, height = 6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               S.o.matrix, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
    ...
    pdf(paste(filename, "Brine.pdf"), width = 6, height = 6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               S.b.matrix, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.7, cex.axis=1.6, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
    ...
    pdf(paste(filename, "Clay.pdf"), width = 6, height = 6)
    image.plot(x=inline[xline.idx,inline.idx], y = -xline[xline.idx,inline.idx], 
               V.c.matrix, xlab="inline", ylab="xline", 
               main = "", col = viridis(128), axes = F, 
               cex.lab=1.4, cex.axis=1.3, legend.width = 1.5, legend.shrink=1, 
               zlim = c(0,1),
               axis.args=list(at=breaks, labels=breaks, cex.axis=1.6))
